  ...
  return (
    <div className="min-h-svh">
      ...
      <section className="relative overflow-hidden bg-invert">
        ...
        {/* Ambient glow */}
        <div className="absolute left-1/2 top-0 size-[700px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-info/[0.08] blur-[150px]" />
        <div className="absolute -bottom-32 -right-20 size-[500px] rounded-full bg-success/[0.07] blur-[120px]" />

        <div className="relative z-10 mx-auto max-w-6xl px-6 pb-20 pt-20 md:pb-28 md:pt-28">
          {/* Badge */}
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-invert-foreground/[0.08] bg-invert-foreground/[0.04] px-3.5 py-1.5 backdrop-blur-sm">
          ...
          <p className="mt-5 max-w-lg text-[15px] leading-relaxed text-invert-foreground/40 md:text-base">
            Streamline procurement, track stock across every department, and make
            smarter purchasing decisions — all from a single platform built for
            modern hotels.
          </p>
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3">
            ...
            <Button
              ...
              size="lg"
              variant="ghost"
              className="text-invert-foreground/60 hover:bg-invert-foreground/[0.06] hover:text-invert-foreground/80"
            >
              <a href="#features">
          ...
          <div className="relative mt-16 hidden h-[240px] md:block">
            {/* Card: Overview */}
            <div className="absolute left-0 top-0 w-[260px] rounded-2xl border border-invert-foreground/[0.06] bg-invert-foreground/[0.03] p-5 shadow-2xl shadow-black/20 backdrop-blur-md">
              ...
              <div className="space-y-3">
                {[
                  { label: "Total Items", val: "2,847", pct: 78, bar: "var(--info)" },
                  { label: "Low Stock", val: "23", pct: 12, bar: "var(--warning)" },
                  { label: "On Order", val: "156", pct: 52, bar: "var(--success)" },
                ].map((r) => (
                  <div key={r.label}>
            ...
            {/* Card: Activity */}
            <div className="absolute left-[290px] top-4 w-[240px] rounded-2xl border border-invert-foreground/[0.06] bg-invert-foreground/[0.03] p-5 shadow-2xl shadow-black/20 backdrop-blur-md">
            ...
            {/* Card: Quick stat */}
            <div className="absolute right-0 top-8 w-[200px] rounded-2xl border border-invert-foreground/[0.06] bg-invert-foreground/[0.03] p-5 shadow-2xl shadow-black/20 backdrop-blur-md xl:right-16">
          ...
          {/* Stats strip */}
          <div className="mt-12 flex flex-wrap items-center gap-x-10 gap-y-4 border-t border-invert-foreground/[0.06] pt-8 md:mt-8">
            {[
      ...
      {/* ── Features ── */}
      <section id="features" className="border-t bg-background py-20 md:py-28">
        <div className="mx-auto max-w-6xl px-6">
          <div className="max-w-lg">
            <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-muted-foreground">
              Modules
            </p>
            <h2 className="mt-2 text-[clamp(24px,3.5vw,36px)] font-bold leading-tight tracking-tight">
          ...
          <div className="mt-14 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {modules.map((m) => (
              <div
                key={m.title}
                className="group rounded-2xl border bg-card p-6 transition-colors hover:border-border/80 hover:bg-accent/30"
              >
                <div
      ...
      {/* ── CTA ── */}
      <section className="relative overflow-hidden border-t bg-invert">
        <div className="absolute left-1/2 top-1/2 size-[500px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-info/[0.06] blur-[120px]" />
      ...
      <footer className="border-t bg-background">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-6">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-semibold">Carmen</span>
          </div>
